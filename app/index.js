...
module.exports = generators.Base.extend({
    ...
    prompting: function () {
        var that = this;
        this.log(yosay('Welcome to ' + chalk.yellow('ngen (Angular app)') + ' generator !!'));
        ...
        return this.prompt([{
            type: 'input',
            name: 'ngappname',
            message: 'Please enter the Angular App Name.',
            ...
            generatorParams = {
                appName: _.startCase(answers.ngappname),
                moduleName: _.camelCase(answers.ngappname),
                includeLodash: _.includes(answers.jslibs, 'lodash'),
                includeMoment: _.includes(answers.jslibs, 'momentjs'),
                includerxjs: _.includes(answers.jslibs, 'includerxjs')
            };
        });
    },
    ...
    writing: {
        appStaticFiles: function () {
            ...
            this.copy('products/_products.less', 'src/products/products.less');
            this.copy('products/detail/_detail.less', 'src/products/detail/detail.less');
            this.copy('common/components/_appLoading.less', 'src/common/components/appLoading.less');
            this.copy('common/components/appNavBar/_appNavBar.less', 'src/common/components/appNavBar/appNavBar.less');
        ...
        html: function () {
            ...
            this.fs.copyTpl(
                this.templatePath('products/_products.html'),
                this.destinationPath('src/products/products.html'), generatorParams
            );

            this.fs.copyTpl(
                this.templatePath('products/detail/_detail.html'),
                this.destinationPath('src/products/detail/detail.html'), generatorParams
            );

            this.fs.copyTpl(
                this.templatePath('common/components/appNavBar/_appNavBar.html'),
                this.destinationPath('src/common/components/appNavBar/appNavBar.html'), generatorParams
            );
        },
        script: function () {
            this.fs.copyTpl(
            ...
            this.fs.copyTpl(
                this.templatePath('products/_productsCtrl.js'),
                this.destinationPath('src/products/productsCtrl.js'), generatorParams
            );


            this.fs.copyTpl(
                this.templatePath('products/_productsCtrl.spec.js'),
                this.destinationPath('src/products/productsCtrl.spec.js'), generatorParams
            );

            this.fs.copyTpl(
                this.templatePath('products/_productsRouteConfig.js'),
                this.destinationPath('src/products/productsRouteConfig.js'), generatorParams
            );


            this.fs.copyTpl(
                this.templatePath('products/detail/_detailCtrl.js'),
                this.destinationPath('src/products/detail/detailCtrl.js'), generatorParams
            );


            this.fs.copyTpl(
                this.templatePath('products/detail/_detailCtrl.spec.js'),
                this.destinationPath('src/products/detail/detailCtrl.spec.js'), generatorParams
            );
            ...
            this.fs.copyTpl(
                this.templatePath('common/components/appNavBar/_appNavBar.js'),
                this.destinationPath('src/common/components/appNavBar/appNavBar.js'), generatorParams
            );

            this.fs.copyTpl(
                this.templatePath('common/components/appNavBar/_appNavBar.spec.js'),
                this.destinationPath('src/common/components/appNavBar/appNavBar.spec.js'), generatorParams
            );
        ...
        bower: function () {
            ...
            bowerJson.dependencies['bootstrap-css'] = '^3.3.6';
    ...
    install: function () {
        ...
        return this.prompt([{
            ...
            if (that.config.get('installdep') == 'Y') {
